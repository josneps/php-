...
//                ->select();
            ...
            //不是设计师请返回
            $this->error('不是设计师请返回','javascript:history.back(-1);',3);
        }
    ...
    {//只有业主才可以进来
        if(!empty($this->userInfo) && $this->userInfo['type'] == 0){
            //根据问题获取答案
            //接收状态
            ...
            //不是业主请返回
            $this->error('不是业主请返回','javascript:history.back(-1);',3);
        }
    ...
    public function addQuestions()
    {
        ...
        if (IS_POST) {
            ...
            $this->view('QuestionAnswer/addQuestions', 3);
        }
